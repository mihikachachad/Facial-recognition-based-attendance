...
config = {
    "apiKey": "AIzaSyAXjMHbgBw3Z2nooe8TwkNCNGphxYA0-Ck",
    "authDomain": "smart-attendance-1-b6af3.firebaseapp.com",
    "databaseURL": "https://smart-attendance-1-b6af3-default-rtdb.firebaseio.com",
    "projectId": "smart-attendance-1-b6af3",
    "storageBucket": "smart-attendance-1-b6af3.appspot.com",
    "messagingSenderId": "718530147615",
    "appId": "1:718530147615:web:25900bd1880db5fc016c2a"
}

firebase = firebase.FirebaseApplication("https://smart-attendance-1-b6af3-default-rtdb.firebaseio.com", None)
blob = Blob.from_string("gs://smart-attendance-1-b6af3.appspot.com")
...
def trackImages():
    ...
    data =  { 'name': "Date_"+date+"  Time_"+Hour+"-"+Minute+"-"+Second, 'url': "https://firebasestorage.googleapis.com/v0/b/smart-attendance-1-b6af3.appspot.com/o/uploads%2FAttendance%5CAttendance_"+date+"_"+Hour+"-"+Minute+".csv?alt=media&token="+blob['downloadTokens']}
...
lbl3 = tk.Label(window, text="Sardar Patel Institute of Technology", width=80, fg="white", bg="black", font=('times', 15, ' bold')) 
